...
public interface LoginService {
     ...
     */
    List<? extends YggdrasilLoginService.Profile> login(String agent, String id, String password)
            throws IOException, InterruptedException, AuthenticationException;

    StoredSession refreshSession(Account account)
            throws IOException, AuthenticationException, InterruptedException;

    boolean needsRefresh(Account account);
}
