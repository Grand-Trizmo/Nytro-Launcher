...
public final class Launcher {
    ...
    @Getter private final File cacheDir;
    ...
    public void setDefaultConfig() {
        if (this.config.isMemoryManaged()) {
            this.setOptimizedMemoryConfig();
        }
    }

    public void setOptimizedMemoryConfig() {
        ...
        config.setYoungGen(128);
        config.setMinMemory(320);
        config.setMemoryManaged(true);
    }
