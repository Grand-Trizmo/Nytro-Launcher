...
public class Bootstrap {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        if (!isJava8()) {
            JOptionPane.showMessageDialog(null, "The Nytro launcher requires Java 8 or newer. Please update your installation of Java.", "Outdated Java", JOptionPane.ERROR_MESSAGE);
    ...
    private static void addLetsEncryptSSL() {
        try {
            ...
            InputStream caInput = new BufferedInputStream(Bootstrap.class.getResourceAsStream("cert.der"));
